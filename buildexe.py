...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "bowlingscorer.py"

        #Name of program
        self.project_name = "OpenScore"

        #Project url
        self.project_url = "http://openscore.catster.net/"

        #Version of program
        self.project_version = "1.4"

        #License of the program
        self.license = "GNU GPL"

        #Auhor of program
        self.author_name = "Jimmy Lipham"
        self.author_email = "jimmy@catster.net"
        self.copyright = "Copyright (c) 2012 Catster Networks"

        #Description
        self.project_description = "Super duper awesome bowling scorer... of doom"
